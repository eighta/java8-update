...
----------------------------------------
Data is information. A piece of data is one fact, such as your first name. 
A database is an organized collection of data. 
In the real world, a file cabinet is a type of database. 
It has file folders, each of which contains pieces of paper. 
The file folders are organized in some way, often alphabetically. 
Each piece of paper is like a piece of data. Similarly, the folders on your
computer are like a database. 
The folders provide organization, and each file is a piece of data.
A relational database is a database that is organized into tables, which consist of rows and columns. 
You can think of a table as a spreadsheet. 
...
code, and you get your data in Java objects. 

>>A relational database is accessed through Structured Query Language (SQL).

>>In addition to relational databases, there is another type of database called a NoSQL database. 
This is for databases that store their data in a format other than tables.
...
Luckily, Java comes with an embedded database called JavaDB. 
JavaDB is a version of the open source Derby database that comes automatically with the JDK
